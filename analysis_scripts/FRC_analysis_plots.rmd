...
#### Supp. Figure 5 - Mitotracker staining
```{r, echo=TRUE, warning=FALSE,dpi = 300,fig.height=4,fig.width=12}
...
ggsave(plot=plot, file="Supp_Figure_5.png", type = "cairo-png",  bg = "transparent",dpi = 300,height=4,width=12)
